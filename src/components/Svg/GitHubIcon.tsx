...
export const GitHubIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="none" stroke="currentColor" strokeWidth={2} strokeLinejoin="round" strokeLinecap="round">
      <path d="M12 4c1.67 0 2.61.4 3 .5.53-.43 1.94-1.5 3.5-1.5.34 1 .29 2.22 0 3 .75 1 1 2 1 3.5 0 2.19-.48 3.58-1.5 4.5-1.02.92-2.11 1.37-3.5 1.5.65.54.5 1.87.5 2.5v3M12 4c-1.67 0-2.61.4-3 .5C8.47 4.07 7.06 3 5.5 3c-.34 1-.29 2.22 0 3-.75 1-1 2-1 3.5 0 2.19.48 3.58 1.5 4.5 1.02.92 2.11 1.37 3.5 1.5-.65.54-.5 1.87-.5 2.5v3" />
      <path d="M9 19c-1.41 0-2.84-.56-3.69-1.19-.84-.63-1.09-1.66-2.31-2.31" />
    </g>
  </svg>
)
